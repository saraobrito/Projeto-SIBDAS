<?php
    $page_title = "Categorias - Hospital Praia Dourada";
        ...
        <header class="cabecalho-dashboard border-bottom shadow-sm" style="background-color: #f0f7fd; padding: 20px 30px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
            <div class="d-flex align-items-center gap-4">
                ...
                <div>
                    ...
                    <p style="color: #666; margin: 0;">Organização dos tipos de equipamentos e dispositivos médicos.</p>
                </div>
            </div>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                    ...
                    <li><a class="dropdown-item text-danger" href="/Projeto SIBDAS/public/index.php"><i class="fa-solid fa-right-from-bracket me-2"></i>Sair</a></li>
                </ul>
            </div>
        </header>
