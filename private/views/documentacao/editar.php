                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="mb-0 text-dark fw-bold">
                            <i class="fa-solid fa-pen-to-square me-2" style="color: #ff9800;"></i> Editar Documento
                        </h2>
                    </div>
                    <hr class="mb-4">

                    <form action="/Projeto SIBDAS/private/views/documentacao/documentacao.php" method="POST">

                        <h5 class="fw-bold mb-3" style="color: #1976d2;">1. Identificação do Documento</h5>
                        <div class="row bg-light rounded-4 p-3 mb-4 mx-0 shadow-sm border border-light">
                            <div class="col-md-12 mb-3">
                                <div class="custom-input-group mb-0">
                                    ...
                                    <input type="text" id="nome_doc" name="nome_doc" value="Manual_Utilizador_V500.pdf" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3 mb-md-0">
                                <div class="custom-input-group mb-0">
                                    ...
                                    <select id="categoria" name="categoria" required>
                                        <option value="manual" selected>Manual de Utilizador</option>
                            ...
                            <div class="col-md-6">
                                <div class="custom-input-group mb-0">
                                    <label for="arquivo_update">Atualizar Ficheiro (Opcional)</label>
                                    <input type="file" id="arquivo_update" name="arquivo_update" style="padding-top: 8px;">
                                </div>
                            </div>
                        </div>

                        <h5 class="fw-bold mb-3" style="color: #1976d2;">2. Reatribuição de Equipamento</h5>
                        <div class="row bg-light rounded-4 p-3 mb-4 mx-0 shadow-sm border border-light">
                            <div class="col-md-12">
                                <div class="custom-input-group mb-0">
                                    <label for="equipamento_id">Equipamento Associado *</label>
                                    <select id="equipamento_id" name="equipamento_id" required>
                                        <option value="04.002.00" selected>04.002.00 - Ventilador Pulmonar V500</option>
                        ...
                        <div class="bg-light rounded-4 p-3 border-start border-4 border-warning shadow-sm mb-4">
                            <div class="custom-input-group mb-0">
                                <label for="observacoes"><i class="fa-solid fa-circle-info me-1"></i> Notas Técnicas</label>
                                <textarea id="observacoes" name="observacoes" rows="3">Documento atualizado conforme revisão de Maio de 2026.</textarea>
                            </div>
                        </div>
