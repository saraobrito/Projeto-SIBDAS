...
<!-- Conteúdo Principal e Navbar-->
    ...
    <header class="cabecalho-dashboard border-bottom shadow-sm" style="background-color: #f0f7fd; padding: 20px 30px; margin: 0; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
        ...
        <section class="seccao-tabela" style="padding: 30px;">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-grow-1" style="max-width: 600px;">
                    ...
                    <div class="position-relative flex-grow-1">
                        ...
                        <input type="text" class="form-control shadow-sm" placeholder="Pesquisar por Código, Nome ou Marca..." style="padding-left: 40px; border-radius: 10px; height: 42px;">
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select class="form-select border-1 shadow-sm rounded-3 bg-light">
                                ...
                                <option value="med">Medicina Interna</option>
                            </select>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 p-0 mt-2 overflow-hidden">
                <div class="table-responsive">
                    <table class="table align-middle table-hover mb-0">
                        <thead class="table-light">
                            <tr>
                                <th class="text-primary ps-4 py-3">Código</th>
                                <th class="text-primary py-3">Equipamento / Marca</th>
                                <th class="text-primary py-3">Localização</th>
                                <th class="text-primary py-3 text-nowrap">Próx. Manutenção</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="font-size: 0.85rem; color: #888;">Philips IntelliVue MP5</span>
                                </td>
                                <td class="text-muted">Cuidados Intensivos</td>
                                <td class="text-muted">15/11/2026</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="font-size: 0.85rem; color: #888;">Dräger Evita V500</span>
                                </td>
                                <td class="text-muted">Cuidados Intensivos</td>
                                <td class="text-muted">02/09/2026</td>
                                <td><span class="badge crit-suporte">Suporte Vida</span></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong>Bomba de Infusão</strong><br>
                                    <span style="font-size: 0.85rem; color: #888;">B. Braun Infusomat</span>
                                </td>
                                <td class="text-muted">Serviço de Medicina</td>
                                <td class="text-muted">20/12/2026</td>
